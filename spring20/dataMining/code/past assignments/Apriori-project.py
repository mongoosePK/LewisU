...
def generateDb(userIndex) :
    ...
    for i in  range(numTransactions) :
        ...
        transaction = random.sample(range(20),10)
...
for user in range(numberUsers) :
    ...
    while len(nonSequenceF[k]) != 0 :
        ...
        k = k+1
    if kValue < len(nonSequenceF) :
        userListnonsequenceDb.append(nonSequenceF[kValue])
...
print("Users sequence database " + str(kValue1) )
...
print("Users nonSequence database " + str(kValue) )
